...
const connect = (state: InitialState, dispatch: any) => {
...
const loadAccounts = (state: InitialState, dispatch: any) => {
  const { api } = state;
...
const SubstrateContextProvider = (props: any) => {
  ...
  neededPropNames.forEach((key) => {
    initialState[key as keyof InitialState] =
...
const useSubstrateState = () =>
  useContext(SubstrateContext).state as InitialState;
