...
<img src="images/democracy/Screenshot 2023-03-21 at 16.40.51.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 16.42.22.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 16.52.50.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 16.56.02.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 17.06.21.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 17.25.27.png" width="400" style="padding-left: 50px;">

- Use the following settings for the proposal:

<img src="images/democracy/Screenshot 2023-03-21 at 17.27.57.png" width="400" style="padding-left: 50px;">

- Wait for approximately 2 block times(in our case it is 6 seconds for a block) for the proposal to appear on the dashboard.

<img src="images/democracy/Screenshot 2023-03-21 at 17.31.27.png" width="400" style="padding-left: 50px;">

- Go to the `Governance` section to start voting

<img src="images/democracy/Screenshot 2023-03-21 at 17.32.57.png" width="400" style="padding-left: 50px;">

- Press `Thumbs Up` btn to vote `aye` for the proposal and wait until the counter increases to make sure your vote is counted

<img src="images/democracy/Screenshot 2023-03-21 at 17.35.14.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 17.36.40.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 17.42.31.png" width="400" style="padding-left: 50px;">

- Click `Submit` and wait unit the proposal shows up on the dashboard:

<img src="images/democracy/Screenshot 2023-03-21 at 17.44.49.png" width="400" style="padding-left: 50px;">

- Go to `Governance` section and wait until the proposal becomes the referendum

<img src="images/democracy/Screenshot 2023-03-21 at 17.45.45.png" width="400" style="padding-left: 50px;">

### Referendum Voting

- Go to `Governance --> Referendum` to start voting

<img src="images/democracy/Screenshot 2023-03-21 at 17.48.44.png" width="400" style="padding-left: 50px;">

- Use some amount of governance tokens to vote `aye` for the proposal

<img src="images/democracy/Screenshot 2023-03-21 at 17.49.18.png" width="400" style="padding-left: 50px;">

- Observe that token that you voted with are now locked

<img src="images/democracy/Screenshot 2023-03-21 at 17.59.27.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 17.58.30.png" width="400" style="padding-left: 50px;">
...
<img src="images/democracy/Screenshot 2023-03-21 at 18.09.50.png" width="400" style="padding-left: 50px;">

- Click `unlock` button and observe that tokens has moved from `frozen` state

<img src="images/democracy/Screenshot 2023-03-21 at 18.11.09.png" width="400" style="padding-left: 50px;">
